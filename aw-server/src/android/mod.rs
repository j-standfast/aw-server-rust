...
pub mod android {
    ...
    // `#[rocket::main]` requires a zero-arg function, so the host is passed
    // in via the SERVER_HOST static, set by the JNI entry point above.
    #[rocket::main]
    async fn start_server() {
        ...
        unsafe {
            ...
            server_config.address = SERVER_HOST
                .clone()
